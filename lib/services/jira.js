...
(function() {
  ...
  _receiveWebhook = function(arg) {
    var JIRA_CREATE_EVENT, JIRA_UPDATE_EVENT, attachment, body, message, payload;
    body = arg.body;
    payload = body;
    message = {};
    attachment = {
    ...
    if (body.webhookEvent === JIRA_CREATE_EVENT) {
    ...
    } else if (body.webhookEvent === JIRA_UPDATE_EVENT) {
  ...
  module.exports = function() {
    ...
    this.iconUrl = util["static"]('images/icons/jira@2x.png');
    this._fields.push({
      key: 'webhookUrl',
      type: 'text',
      readonly: true,
